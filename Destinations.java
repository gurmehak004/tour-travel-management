...
public class Destinations extends JFrame implements Runnable{
    ...
    public void run() {
        String[] text=new String[]{"The Golden Hues Inn","Serene Sanctuary","The Skyline Manor","Whispering Pines Resort","The Urban Canvas Hotel","The Tranquil Retrea","The Gilded Garden Inn","The Royal Respite Hotel","Luxe Lagoon","The Noble Nook"};
        try {
            for(int i=0;i<9;i++) {
